...
public class BattleA extends JPanel{
	private ImageIcon battle1;
	JLabel background;
	JButton ability1;
	JButton ability2;
	JButton ability3;
	...
	public BattleA(Map m,Monster mon) {
		this.setLayout(null);
		...
		this.monsterState = new JLabel(m.getM1().getName()+" LV:"+m.getM1().getLevel()+" HP:"+m.getM1().getHealth());
		...
		this.battle1 = new ImageIcon("battle1.png");
		this.background = new JLabel();
		this.background.setIcon(battle1);

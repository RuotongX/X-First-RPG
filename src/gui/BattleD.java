...
public class BattleD extends JPanel{
	private ImageIcon battle4;
	JLabel background;
	JButton ability1;
	JButton ability2;
	JButton ability3;
	...
	public BattleD(Map m,Monster mon) {
		this.setLayout(null);
		...
		this.monsterState = new JLabel(m.getBoss().getName()+" LV:"+m.getBoss().getLevel()+" HP:"+m.getBoss().getHealth());
		...
		this.battle4 = new ImageIcon("battle4.png");
		this.background = new JLabel();
		this.background.setIcon(battle4);
	...
	public void update(Map m) {
		...
		this.monsterState.setText(m.getBoss().getName()+" LV:"+m.getBoss().getLevel()+" HP:"+m.getBoss().getHealth());
		this.monsterState.setVisible(true);

...
public class BattleC extends JPanel {
	private ImageIcon battle3;
	JLabel background;
	JButton ability1;
	JButton ability2;
	JButton ability3;
	...
	public BattleC(Map m, Monster mon) {
		...
		this.monsterState = new JLabel(m.getM3().getName()+" LV:"+m.getM3().getLevel()+" HP:"+m.getM3().getHealth());
		...
		this.battle3 = new ImageIcon("battle3.png");
		this.background = new JLabel();
		this.background.setIcon(battle3);
	...
	public void update(Map m) {
		...
		this.monsterState.setText(m.getM3().getName()+" LV:"+m.getM3().getLevel()+" HP:"+m.getM3().getHealth());
		this.monsterState.setVisible(true);
